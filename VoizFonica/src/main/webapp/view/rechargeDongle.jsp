...
<title>VoizFonica- Recharge Mobile</title>
<link rel="icon"
...
<h2 align="center">Recharge Your Dongle</h2>
<div class="container">
	<div class="d-flex justify-content-center h-100">
		<div class="card">
			<div class="card-header">
				<h3>Recharge Dongle </h3>
				<div class="d-flex justify-content-end social_icon">
				</div>
			</div>
			<div class="card-body">
				<form class="form-horizontal" action="/rechargeDongle" >
					 <div class="input-group form-group">
						<div class="input-group-prepend">
							<span class="input-group-text"><i class="fas fa-mobile"></i></span>
						</div>  
						<input type="text" class="form-control" placeholder="sim number" name="phno" required>
