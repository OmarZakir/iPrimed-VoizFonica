	...
	<div class="d-flex justify-content-center h-100">
		<div class="card">
			<div class="card-header">
				<h3>Sign Up as a New Admin </h3>
				<div class="d-flex justify-content-end social_icon">
				</div>
			</div>
			<div class="card-body">
				<form class="form-horizontal" action="/saveAdmin" method="post"oninput='password.setCustomValidity(password.value != password1.value ? "Passwords do not match." : "")'>
