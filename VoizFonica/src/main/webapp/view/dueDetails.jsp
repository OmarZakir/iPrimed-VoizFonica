...
<h3 style=" margin-left : 8vw;">User Plan Details</h3>
<small style="color:white;">img</small>
<form style=" margin-left : 8vw;" action="api/paymentBill">
<div  class="form-group row">
  ...
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-3 col-form-label">Active Plan</label>
    <div class="col-sm-2">
    <c:forEach var="postpaid" items="${planList}">
      <input type="text" readonly class="form-control-plaintext" id="staticEmail" value="${postpaid.planName} Plan"></c:forEach>
    </div>
  </div>
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-3 col-form-label">Due Amount</label>
    <div class="col-sm-2">
    <c:forEach var="postpaid" items="${planList}">
      <input type="text" readonly class="form-control-plaintext" id="staticEmail" value="Rs.${postpaid.dueAmount}/-"></c:forEach>
    </div>
  </div>
  <div class="form-group row">
    <label for="staticEmail" class="col-sm-3 col-form-label">Due Date</label>
    <div class="col-sm-2">
    <c:forEach var="postpaid" items="${planList}">
      <input type="text" readonly class="form-control-plaintext" id="staticEmail" value="${postpaid.duedate}"></c:forEach>
    </div>
  </div>
