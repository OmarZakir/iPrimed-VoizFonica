...
<div class = "header">
    <h1 align="Center"><b>Complaint Form</b></h1>
    </div>
<div class= "mainform" >
    <form:form method="POST"   class="form-horizontal" action="/saveComplaint" modelAttribute="bill">
    <div class="form-group">
        <label for="phoneNo"><b>Phone number:</b></label>
        <input type="text" class="form-control" id="fname" placeholder="Enter Registered Mobile Number" name="phno" required>
      </div>
