...
<title>VoizFonica | Dongle Plans</title>
<link rel="icon"
...
#generic_price_table .generic_content .generic_feature_list ul li:hover{
  ...
  border-left: 5px solid #3d55d9;
}

#generic_price_table .generic_content .generic_price_btn a{
  border: 1px solid #3d55d9; 
    color: #3d55d9;
} 

#generic_price_table .generic_content.active .generic_head_price .generic_head_content .head_bg,
#generic_price_table .generic_content:hover .generic_head_price .generic_head_content .head_bg{
  border-color: #3d55d9 rgba(0, 0, 0, 0) rgba(0, 0, 0, 0) #3d55d9;
  color: #fff;
}
...
<div id="generic_price_table" class="center">   
<section>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="price-heading clearfix">
                        <h1>Dongle Prepaid Plans</h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-4">
                    <div class="generic_content clearfix">
                        ...
                        <div class="generic_feature_list">
                          <ul>
                              <li><span>1.5GB</span> Daily Data Limit</li>
                                <li><span>150kb/s</span> Speed After Data Limit</li>
                                <li><span>30 Days</span> Validity</li>
                            </ul>
                        </div>
                        <!--//FEATURE LIST END-->
                        ...
                        <div class="generic_price_btn clearfix">
                          <a class="" href="./rechargeDongle">Recharge now!</a>
                        </div>
                        <!--//BUTTON END-->
                ...
                <div class="col-md-4">
                  ...
                  <!--PRICE CONTENT START-->
                    <div class="generic_content clearfix">
                        ...
                        <div class="generic_feature_list">
                          <ul>
                              <li><span>2.5GB</span> Daily Data Limit</li>
                                <li><span>150kb/s</span> Speed After Data Limit</li>
                                <li><span>30 Days</span> Validity</li>
                            </ul>
                        </div>
                ...
                <div class="col-md-4">
                  ...
                  <!--PRICE CONTENT START-->
                    <div class="generic_content clearfix">
                        ...
                        <div class="generic_feature_list">
                          <ul>
                             <li><span>4.5GB</span> Daily Data Limit</li>
                                <li><span>150kb/s</span> Speed After Data Limit</li>
                                <li><span>30 Days</span> Validity</li>
                            </ul>
                        </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="generic_content clearfix">
                        ...
                        <div class="generic_feature_list">
                          <ul>
                              <li><span>2GB</span> Daily Data Limit</li>
                              <li><span>150kb/s</span> Speed After Data Limit</li>
                                <li><span>Bill Cycle</span> Validity</li>
                            </ul>
                        </div>
                        <!--//FEATURE LIST END-->
                        ...
                        <!--BUTTON START-->
                        <div class="generic_price_btn clearfix">
                          <a class="" href="./payBillDongle">Select Plan</a>
                        </div>
                        <!--//BUTTON END-->
                ...
                <div class="col-md-4">
                  ...
                  <!--PRICE CONTENT START-->
                    <div class="generic_content clearfix">
                        ...
                        <div class="generic_feature_list">
                          <ul>
                              <li><span>3.5GB</span> Daily Data Limit</li>
                                <li><span>150kb/s</span> Speed After Data Limit</li>
                                <li><span>Bill Cycle</span> Validity</li>
                            </ul>
                        </div>
                ...
                <div class="col-md-4">
                  ...
                  <!--PRICE CONTENT START-->
                    <div class="generic_content clearfix">
                        ...
                        <div class="generic_feature_list">
                          <ul>
                             <li><span>6GB</span> Daily Data Limit</li>
                                <li><span>150kb/s</span> Speed After Data Limit</li>
                                <li><span>Bill Cycle</span> Validity</li>
                            </ul>
                        </div>
