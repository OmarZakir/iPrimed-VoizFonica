...
<title>VoizFonica | Register</title>
<link rel="icon"
...
<div class="container">
	<div class="d-flex justify-content-center h-100">
		<div class="card">
			...
			<div class="card-body">
				<form class="form-horizontal" action="/saveUser" method="post"oninput='password.setCustomValidity(password.value != password1.value ? "Passwords do not match." : "")'>
			...
			<div class="card-footer">
				...
				<div class="d-flex justify-content-center">
					<a href="./loginUser">Already a User?</a>
				</div>
			</div>
		</div>
	</div>
