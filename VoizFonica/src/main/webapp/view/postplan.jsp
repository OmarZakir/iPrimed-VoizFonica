...
<title>VoizFonica | Postpaid Plans</title>
<link rel="icon"
                ...
                <div class="col-md-4">
                    <div class="generic_content clearfix">
                        ...
                        <div class="generic_price_btn clearfix">
                          <a class="" href="./payBillMobile">Select Plan</a>
                        </div>
                        <!--//BUTTON END-->
                ...
                <div class="col-md-4">
                  ...
                  <!--PRICE CONTENT START-->
                    <div class="generic_content clearfix">
                        ...
                        <div class="generic_feature_list">
                          <ul>
                              <li><span>35GB</span>  Data Limit</li>
                                <li><span>150kb/s</span> Speed After Data Limit</li>
                                <li><span>Bill Cycle</span> Validity</li>
                                <li><span>Unlimited</span> Talktime</li>
                            </ul>
                        </div>
                        <!--//FEATURE LIST END-->
                ...
                <div class="col-md-4">
                  ...
                  <!--PRICE CONTENT START-->
                    <div class="generic_content clearfix">
                        ...
                        <div class="generic_feature_list">
                          <ul>
                             <li><span>150GB</span>  Data Limit</li>
                                <li><span>150kb/s</span> Speed After Data Limit</li>
                                <li><span>Bill Cycle</span> Validity</li>
                                <li><span>Unlimited</span> Talktime</li>
                            </ul>
